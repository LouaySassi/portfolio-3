  ...
  return <header className="sticky top-0 w-full px-4 sm:px-6 md:px-8 lg:px-10 mx-auto pt-6 pb-6 z-50">
      <div className="relative flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
          ...
          <a href="/Louay CV PFE english (latest).pdf" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-xs sm:text-sm font-medium whitespace-nowrap text-[#f2f2f2]/80 hover:text-white transition-colors" style={{
          fontFamily: '"Neue Montreal", sans-serif'
        }}>
            Resume
            <ExternalLink className="w-3 h-3" />
